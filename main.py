...
def main():
    ...
    while 1:
        ...
        if showstartscreen == TRUE:
            ...
            pygame.draw.rect(screen,WHITE,Rect(apple,BLOCKSIZE))
            pygame.display.flip()
            clock.tick(29)
            ...
            text_surface = font.render("NAKE GAME", True, WHITE)
            screen.blit(text_surface, (220,180))
            font = pygame.font.SysFont("arial", 24)
            text_surface = font.render("Move the snake with the arrow keys to eat the apples", True, WHITE)
            screen.blit(text_surface, (50,300))
            text_surface = font.render("Avoid the walls and yourself !", True, WHITE)
            screen.blit(text_surface, (50,350))
            text_surface = font.render("Press s to start a new game - Press q to quit at any time", True, WHITE)
            screen.blit(text_surface, (50,400))
            text_surface = font.render("Press p to pause r to resume at any time", True, WHITE)
        ...
        if snakedead == TRUE:
            ...
            text_surface = font.render("Your Score: " + str (score), True, WHITE)
            screen.blit(text_surface, (250,300))
            font = pygame.font.SysFont("arial", 24)
            text_surface = font.render("Press q to quit", True, WHITE)
            screen.blit(text_surface, (300,400))
            text_surface = font.render("Press n to play again", True, WHITE)
